...
-- ============================================================
-- BUSINESSES THAT OFFER SERVICES (Category: services)
-- ============================================================
insert into public.listings
  (id, category_id, title, subtitle, description, location, county, constituency, area_code,
   keywords, service_type, on_site, charges, whatsapp, email, logo_url,
   phone, tags, user_id, verified, available, rating, review_count, created_at)
values
  ('s0000002-0000-0000-0000-000000000001', 'services',
   'Prime Surveying Co.', 'Land Surveying & Beacons',
   'Professional land surveying services with over 10 years experience. Specialising in boundary surveys, topographic surveys, and beacon installation. Title deed verification and company registration support available.',
   'Kilimani, Nairobi', 'Nairobi', 'Westlands', 'Kilimani',
   ARRAY['Surveying', 'Land Survey', 'Beacons', 'Title Deeds', 'GIS Mapping'],
   'Land Surveying', true, 'From KSh 15,000', '+254 712 345 678', 'info@primesurvey.co.ke', '',
   '+254 712 345 678', ARRAY['Surveying', 'Land', 'Beacons', 'Title Deeds'],
   v_seed, true, true, 4.8, 67, now() - interval '40 days'),

  ('s0000002-0000-0000-0000-000000000002', 'services',
   'Elite Cleaning Services', 'Commercial & Residential Cleaning',
   'Reliable cleaning company serving offices, homes, and commercial spaces. Deep cleaning, carpet cleaning, and post-construction cleanup. Trained staff and eco-friendly products.',
   'Westlands, Nairobi', 'Nairobi', 'Westlands', 'Westlands',
   ARRAY['Office Cleaning', 'Deep Cleaning', 'Carpet Cleaning', 'House Cleaning'],
   'Cleaning Services', true, 'From KSh 3,000', '+254 723 456 789', 'hello@eliteclean.co.ke', '',
   '+254 723 456 789', ARRAY['Cleaning', 'Office', 'Commercial', 'Residential'],
   v_seed, true, true, 4.7, 143, now() - interval '25 days'),

  ('s0000002-0000-0000-0000-000000000003', 'services',
   'TechPrint Solutions', 'Printing & Design Studio',
   'Full-service printing and design studio. Business cards, flyers, banners, branded merchandise, and digital design. Fast turnaround and quality guaranteed.',
   'Upper Hill, Nairobi', 'Nairobi', 'Karura', 'Upper Hill',
   ARRAY['Printing', 'Design', 'Branding', 'Flyers', 'Business Cards'],
   'Printing & Design', false, 'From KSh 500', '+254 734 567 890', 'print@techprint.co.ke', '',
   '+254 734 567 890', ARRAY['Printing', 'Design', 'Branding', 'Marketing'],
   v_seed, true, true, 4.6, 89, now() - interval '20 days'),

  ('s0000002-0000-0000-0000-000000000004', 'services',
   'FixIt Electrical & Plumbing', 'Repair & Installation Centre',
   'Trusted electrical and plumbing repair centre. Wiring, pipe repair, AC servicing, and general maintenance. Emergency callouts available across Nairobi.',
   'Eastleigh, Nairobi', 'Nairobi', 'Embakasi Central', 'Eastleigh',
   ARRAY['Electrical Repair', 'Plumbing', 'AC Repair', 'Maintenance'],
   'Repair Services', true, 'Negotiable', '+254 745 678 901', '', '',
   '+254 745 678 901', ARRAY['Electrical', 'Plumbing', 'Repair', 'Maintenance'],
   v_seed, false, true, 4.5, 211, now() - interval '15 days'),

  ('s0000002-0000-0000-0000-000000000005', 'services',
   'BrightMinds Consultancy', 'Business & Marketing Consultancy',
   'Strategic business and marketing consultancy helping SMEs grow. Services include brand strategy, digital marketing, SEO, and business plan development.',
   'Kilimani, Nairobi', 'Nairobi', 'Westlands', 'Kilimani',
   ARRAY['Business Consultancy', 'Marketing Strategy', 'Brand Strategy', 'SEO'],
   'Consultancy', false, 'From KSh 8,000', '+254 756 789 012', 'hello@brightminds.co.ke', '',
   '+254 756 789 012', ARRAY['Consulting', 'Marketing', 'Business', 'Strategy'],
   v_seed, true, true, 4.9, 34, now() - interval '10 days');
